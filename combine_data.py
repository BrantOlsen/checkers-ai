...
def ConvertBoardStateToRow(board_state):
  """Convert a matrix of the board state into a vector"""
  board_data = numpy.asarray(board_state).reshape(-1)
  ...
  for file in os.listdir(folder):
    if ('.' + player_one_or_two + '.' in file):
      ...
      for board in data:
        ...
        board_data = ConvertBoardStateToRow(board['board_state'])
